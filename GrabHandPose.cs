...
public class GrabHandPose : MonoBehaviour
{
    ...
    {
        // 손의 위치와 회전을 정확하게 배치하기 위해 오프셋 적용 직접 실행하면서 구해야함
        h.root.localPosition = newPosition + positionOffset;
    ...
    public IEnumerator SetHandDataRoutine(HandData h, Vector3 newPosition, Quaternion newRotation, Quaternion[] newBonesRotation, Vector3 startingPosition, Quaternion startinngRotation, Quaternion[] startingBonesRotation)
    {
        float timer = 0;
        while (timer < poseTransitionDuration)
        {
            ...
            Quaternion r = Quaternion.Lerp(startinngRotation, newRotation, timer / poseTransitionDuration);
